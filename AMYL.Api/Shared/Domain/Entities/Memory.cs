...
namespace AMYL.Api.Shared.Domain.Entities
{
    public class Memory : AuditableEntity
    {
        ...
        public static Memory Create(string title, string? description,
            DateTime createdAt, MemoryType memoryType, string? imageUrl, string? videoUrl,
            string? audioUrl, string? secretNote, Guid userId)
        {
            return new Memory
            {
                Title = title,
        ...
        public static void Update(Memory memory, string title, string? description,
            MemoryType? memoryType, string? imageUrl, string? videoUrl,
            string? audioUrl)
        {
